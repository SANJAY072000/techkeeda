...
export default class Insp extends Component {
componentWillMount(){
...
class Rinsp extends Component {
  componentWillMount(){
    axios({
      url:'https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=8efb4d00ecb5445d9c27a0addb9bd51e'
    })
    .then(res=>this.setState({inews:res.data.articles}))
    .catch(err=>console.log(err));
    axios({
      url:'https://newsapi.org/v2/top-headlines?country=gb&category=sports&apiKey=8efb4d00ecb5445d9c27a0addb9bd51e'
    })
    .then(res=>this.setState({uk:res.data.articles}))
    .catch(err=>console.log(err));
    axios({
      url:'https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=8efb4d00ecb5445d9c27a0addb9bd51e'
    })
          ...
          <aside id="aside3">
            <div className="row">
              <div className="col-12">
                ...
                Sports Headlines across the Globe !
              </h1>
